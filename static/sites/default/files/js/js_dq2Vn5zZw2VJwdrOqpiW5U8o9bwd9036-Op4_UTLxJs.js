/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/modules/custom/mparticle/js/timeme.min.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/modules/custom/mparticle/js/timeme.min.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/modules/custom/pendo/js/pendo.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/modules/custom/pendo/js/pendo.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/core/misc/jquery.once.bc.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/core/misc/jquery.once.bc.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/modules/contrib/simple_popup_blocks/js/simple_popup_blocks.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/modules/contrib/simple_popup_blocks/js/simple_popup_blocks.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/modules.js. */
  ...
  try{
    ...
    (function ($) {
      ...
      $(document).ready(function () {
        ...
        $('a:not([href^="/"],[href^="#"],[href^="?"],[href*="Gulf Bank"],[href*="texascapitalbank.com"],[href*="bankdirect.com"],[href*="q2ebanking.com"],[href*="?skipcrit=true&skipcart=true"],[href*="?skipcrit=true&amp;skipcart=true"],[href*="tel:"], .toolbar-icon)').bindFirst("click", displayBumper);
      ...
      function displayBumper(event) {
        ...
        var overlayHeader = $('<h1 id="overlay-header" class="text__title tcb-primary-color">You are now leaving Gulf Bank</h1>');
        var overlayText = $('<p>Links to other websites are provided for your convenience. Gulf Bank  does not own or maintain these external sites and is not responsible for their security or privacy practices.</p>');
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/modules.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/lightslider.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/lightslider.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/contact-us.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/contact-us.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/acquia-lift-event-listeners.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/acquia-lift-event-listeners.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/modules/contrib/ckeditor_accordion/js/ckeditor-accordion.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/modules/contrib/ckeditor_accordion/js/ckeditor-accordion.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/lead-form.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.Gulf Bank/themes/custom/sitestudiobask/js/lead-form.js. */;
